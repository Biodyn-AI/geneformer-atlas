      ...
      <section className="space-y-4">
        ...
        <div className="bg-gray-900/50 rounded-xl border border-gray-800 p-6 space-y-4">
          ...
          <p className="text-gray-400 leading-relaxed">
            ...
            <span className="text-gray-200">Geneformer V2-316M</span>, revealing 82,525
            biological features across all 18 transformer layers.
          </p>
      ...
      <section className="space-y-4">
        ...
        <div className="bg-gray-900/50 rounded-xl border border-gray-800 p-6 space-y-3 text-gray-400 leading-relaxed">
          <p>
            ...
            (d=1152, 4x expansion to 4,608 features, k=32) on the residual stream activations of{' '}
            <strong className="text-gray-200">Geneformer V2-316M</strong> across all 18 transformer layers,
            using 4.05 million token positions from K562 cells.
          </p>
          <p>
          ...
          <p>
            Key findings include a U-shaped annotation profile across layers, 141 co-activation
            modules mapping to coherent biological programs, massive superposition (99.8% of
            features are novel directions invisible to PCA/SVD), and causal validation showing
            that individual features specifically drive target gene logits.
          </p>
        </div>
      </section>
      ...
      <section className="space-y-4">
        ...
        <div className="bg-gray-900/50 rounded-xl border border-gray-800 p-6 space-y-3 text-gray-400 leading-relaxed">
          <p>
            ...
            activations were extracted from all 18 layers of Geneformer V2-316M processing
            K562 single-cell transcriptomic data (4.05M positions per layer, 336 GB total).
          </p>
          <p>
            ...
            The 4x expansion ratio (1,152 → 4,608 features) captures fine-grained biological
            representations while maintaining 77-85% variance explained.
          </p>
          <p>
          ...
          <p>
            ...
            on 50 Layer 11 features confirmed that individual features causally drive
            specific gene logits, with 60% achieving specificity ratios &gt; 2.
          </p>
        </div>
      </section>
    </div>
